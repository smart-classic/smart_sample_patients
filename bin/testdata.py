...
POSTAL_INDEX_CHOICES = (0,0,0, # repeated three times--largest population
                        1,1,   # repeated twice, less population
                        2,3,4,5,6,7,8)
        
POSTAL_DATA = ({'city': 'Bixby', 'region': 'OK', 'pcode': '74008', 'country': 'USA'},
